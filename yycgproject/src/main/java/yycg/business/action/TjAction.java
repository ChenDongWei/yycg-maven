...
public class TjAction {
	...
	public @ResponseBody DataGridResultInfo businessList_result(
			ActiveUser activeUser, String year, YycgdQueryVo yycgdQueryVo,
	...
	public @ResponseBody DataGridResultInfo groupByYpxx_result(
			ActiveUser activeUser, String year,// 查询年份
		...
		// 列表总数
		int total = businessService.findYybusinessGroupbyYpxxCount(year, sysid,
		...
		List<YycgdmxCustom> list = businessService
				.findYybusinessGroupbyYpxxList(year, sysid, groupid,
						yycgdQueryVo);
